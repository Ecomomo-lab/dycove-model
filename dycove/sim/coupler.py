...
class VegetationCoupler:
    ...
    def update(self, simstate, hydro):
        """
        ...
        self.do_colonization(simstate, hydro)
    ...
    def do_colonization(self, simstate, hydro):
        """ Compute colonization based on hydrodynamic conditions. """
        self.veg.colonization(simstate.ets, hydro.h_min, hydro.h_max, hydro.fl_dr)
