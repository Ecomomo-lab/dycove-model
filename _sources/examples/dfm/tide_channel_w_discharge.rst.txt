...
This example corresponds to the Python file `run_tide_channel.py` located in the `examples/DFM/tide_channel_w_discharge/` directory, along with supporting input files.
