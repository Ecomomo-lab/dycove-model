...
def constants():
    return {
        # example values for vegetation properties
        "D" : 0.01,
        "m" : 100,
        "hv": 0.5,
        "C" : 65,
        "g" : 9.81,
        "K" : 0.41,
        # example values for vegetation file attributes
        "fraction_0"       : 0.5,
        "start_col_ets"    : 2,
        "end_col_ets"      : 4,
        "rootlength_0"     : 0.5,
...
class TestBaptistOperator:

    @mark.anuga
    @mark.integration
    def test_baptist_quantities(self):
    ...
    @mark.anuga
    @mark.integration
    def test_baptist_Cv_calculation(self):
        from dycove.sim.engines.ANUGA_baptist import Baptist_operator
    ...
    @mark.anuga
    @mark.integration
    def test_baptist_set_vegetation(self):
        from dycove.sim.engines.ANUGA_baptist import Baptist_operator
    ...
    @mark.anuga
    @mark.integration
    def test_baptist_update_quantities_reduces_momentum(self):
        from dycove.sim.engines.ANUGA_baptist import Baptist_operator
