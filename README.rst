...
colonization, growth, and mortality of those species based on hydrodynamic (and morphodynamic) conditions present 
in each grid cell in the numerical model. In turn, the evolving vegetation changes the flow resistance in the 
numerical model. The strength of DYCOVE lies in its ability to model the evolution of coastal vegetation species
...
Refer to the `documentation <https://Ecomomo-lab.github.io/dycove-model/index.html>`_ for installation instructions,
quick-start examples, API reference, and more.
